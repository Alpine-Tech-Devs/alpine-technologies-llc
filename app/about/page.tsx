    ...
    <div className="flex flex-col">
      ...
      <section className="bg-gradient-to-r from-blue-50 to-slate-50 dark:from-slate-900 dark:to-slate-800 px-4 py-20">
        <div className="max-w-3xl mx-auto">
          <h1 className="text-5xl font-bold mb-6">About Alpine Tech</h1>
      ...
      <section className="py-20 px-4 bg-white dark:bg-slate-950">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-6 text-lg text-slate-700 dark:text-slate-300">
            ...
            <p>
              Both of us have spent 4+ years working as professional software engineers at various companies. We've seen firsthand how technology can transform businesses, but we've also witnessed how many small business owners struggle to find trustworthy, affordable partners to build their digital presence.
            </p>
            <p>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-8">
            <div className="p-8 rounded-lg border border-slate-200 dark:border-slate-800">
              ...
              <p className="text-slate-600 dark:text-slate-400 mb-4">4+ years as a software engineer</p>
              <p className="text-slate-700 dark:text-slate-300">
